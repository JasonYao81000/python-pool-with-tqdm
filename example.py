...
n_samples = 40000000
xs = np.random.uniform(low=0.0, high=10, size=(n_samples)).astype(np.int)
ys = np.random.uniform(low=0.0, high=10, size=(n_samples)).astype(np.int)
zs = np.random.uniform(low=0.0, high=10, size=(n_samples)).astype(np.int)
